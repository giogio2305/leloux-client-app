...
const MailSchema = Yup.object().shape({
    ...
    tel: Yup.string()
    .min(9, 'Ce numéro  n\'est pas valide')
...
const persistLogin = (credentials, message, status) => {
    ...
    return (
        ...
        <InnerConatainer>
            ...
            <Formik initialValues={{  tel:tel, id: id, phoneOtp: null}} 
                onSubmit={(values, { setSubmitting }) => {
                    if ( values.tel == '') {
                        handleMessage("Remplissez tous les espaces")
                        setSubmitting(false);
                    } else {
                        if(values.phoneOtp == null){
        ...
        {page==1 &&
        <>
        <SubTitle>Entrez votre nouveau numero ?</SubTitle>
        <ModInput
                                    label=" "
                                    name= 'tel'
                                    icon="call-outline"
                           ...
                           />
                                ...
                                {page==2 &&
        <>
        <SubTitle>Nous vous avons envoyé un code au {values.tel}</SubTitle>
                                    <ModInput
                                    label=" "
                                    name= 'phoneOtp'
                                    icon="call-outline"
                                    ...
                                    placeholderTextColor='#6a6c7b'
                                    onChangeText={handleChange('phoneOtp')}
                        ...
                        <View style={{alignItems:'center', justifyContent: 'center'}}>
                                ...
                                >Votre numéro de téléphone a bien été  modifiée </Text>
                                </View>
                        </>
                        }
