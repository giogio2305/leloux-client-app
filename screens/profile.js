            ...
            navigation.setOptions({
                ...
                headerRight: () => (
                    <View style={{
                        ...
                        <TouchableOpacity style={{marginRight: 8,}} onPress={() => navigation.navigate('histo')}>
                        <Icon color="#fff" type='ionicon' name='file-tray-full-outline' size={28} />
                        <Text style={{fontSize: 12, fontFamily:'osr', color: '#f6f6f6'}}>Historique</Text>
                        </TouchableOpacity>

                        <TouchableOpacity style={{marginRight: 8,}} onPress={() => navigation.navigate('park')}>
                        <Icon color="#fff" type='ionicon' name='car-sport-outline' size={28} />
                        <Text style={{fontSize: 12, fontFamily:'osr', color: '#f6f6f6'}}>Parking</Text>
                        </TouchableOpacity>

                        <TouchableOpacity style={{marginRight: 8,}} onPress={() => navigation.navigate('params')}>
                        <Icon color="#fff" type='ionicon' name='settings-outline' size={28} />
                        <Text style={{fontSize: 12, fontFamily:'osr', color: '#f6f6f6'}}>Parametres</Text>
                        </TouchableOpacity>

                    </View>

                ),
                headerTintColor: '#707cbd',
                            ...
                            <FlatList
                                    ...
                                    renderItem = {({item, index})=>{
                                        ...
                                        <TouchableOpacity style={{        
                                            padding: Dimensions.get('screen').width - '20px',
                                            marginBottom: 20,
                                            flexDirection: 'row',
                                        }}
                                            key={item.id}
                                            ...
                                            <Text style={{fontSize:17.33, color: '#484848',fontFamily: 'osbold'}}>Demande de diagnostic</Text>
